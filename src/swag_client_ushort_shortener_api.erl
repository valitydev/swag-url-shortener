%% -*- mode: erlang -*-
-module(swag_client_ushort_shortener_api).
...
-spec delete_shortened_url(Endpoint :: swag_client_ushort:endpoint(), Params :: map()) ->
    {ok, Code :: integer(), RespHeaders :: list(), Response :: map()} |
    {error, _Reason}.
delete_shortened_url(Endpoint, Params) ->
    delete_shortened_url(Endpoint, Params, []).

-spec delete_shortened_url(Endpoint :: swag_client_ushort:endpoint(), Params :: map(), Opts :: swag_client_ushort:transport_opts()) ->
    {ok, Code :: integer(), RespHeaders :: list(), Response :: map()} |
    {error, _Reason}.
delete_shortened_url(Endpoint, Params, Opts) ->
    process_response(swag_client_ushort_procession:process_request(
        delete,
        swag_client_ushort_utils:get_url(Endpoint, "/v1/shortened-urls/:shortenedUrlID"),
        Params,
        get_request_spec(delete_shortened_url),
        Opts
    ), delete_shortened_url).

-spec get_shortened_url(Endpoint :: swag_client_ushort:endpoint(), Params :: map()) ->
    {ok, Code :: integer(), RespHeaders :: list(), Response :: map()} |
    {error, _Reason}.
get_shortened_url(Endpoint, Params) ->
    get_shortened_url(Endpoint, Params, []).

-spec get_shortened_url(Endpoint :: swag_client_ushort:endpoint(), Params :: map(), Opts :: swag_client_ushort:transport_opts()) ->
    {ok, Code :: integer(), RespHeaders :: list(), Response :: map()} |
    {error, _Reason}.
...
-spec shorten_url(Endpoint :: swag_client_ushort:endpoint(), Params :: map()) ->
    {ok, Code :: integer(), RespHeaders :: list(), Response :: map()} |
    {error, _Reason}.
shorten_url(Endpoint, Params) ->
    shorten_url(Endpoint, Params, []).

-spec shorten_url(Endpoint :: swag_client_ushort:endpoint(), Params :: map(), Opts :: swag_client_ushort:transport_opts()) ->
    {ok, Code :: integer(), RespHeaders :: list(), Response :: map()} |
    {error, _Reason}.
shorten_url(Endpoint, Params, Opts) ->
    process_response(swag_client_ushort_procession:process_request(
        post,
        swag_client_ushort_utils:get_url(Endpoint, "/v1/shortened-urls"),
        Params,
...
process_response({ok, Code, Headers, RespBody}, OperationID) ->
    try swag_client_ushort_procession:process_response(
...
-spec get_request_spec(OperationID :: swag_client_ushort:operation_id()) ->
    Spec :: swag_client_ushort_procession:request_spec() | no_return().
...
-spec get_response_spec(OperationID :: swag_client_ushort:operation_id(), Code :: swag_client_ushort_procession:code()) ->
    Spec :: swag_client_ushort_procession:response_spec() | no_return().
